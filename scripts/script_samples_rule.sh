...
do
        P1=$(cat $2 | awk "/$patient/ {print}" | awk '{print $2}')
        P2=$(cat $2 | awk "/$patient/ {print}" | awk '{print $3}')
        R1=$(cat $2 | awk "/$patient/ {print}" | awk '{print $4}')
        R2=$(cat $2 | awk "/$patient/ {print}" | awk '{print $5}')
